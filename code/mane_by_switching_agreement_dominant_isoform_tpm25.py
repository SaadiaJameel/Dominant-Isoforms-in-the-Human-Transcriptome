...
results_df = pd.read_csv(os.path.expanduser("~/finalproject/results/major_isoforms_tpm25.csv"))
...
# ============================================
# CALCULATE OVERALL MANE AGREEMENT
# FROM SAME FILTERED DATA
# ============================================

overall = merged["mane_agreement_pct"].mean()
print(f"\nOverall MANE agreement (dominant only, TPM >= 25): {overall:.1f}%")
...
output_path = os.path.expanduser(
    "~/finalproject/results/plots/plot_mane_by_dominant_switching_tpm25.png")
