...
# Get one row per gene — mean MANE agreement across samples
# Only uses dominant gene-sample pairs due to filter above
...
print(f"Overall MANE agreement rate (dominant only): {overall_rate:.1f}%")
...
output_path = os.path.expanduser(
    "~/finalproject/results/plots/plot_mane_agreement_by_isoform_count_dominant_only.png")
