...
print(f"Overall MANE agreement rate (dominant only, TPM >= 25): {overall_rate:.1f}%")
...
output_path = os.path.expanduser(
    "~/finalproject/results/plots/plot_mane_agreement_by_isoform_count_dominant_only_tpm25.png")
