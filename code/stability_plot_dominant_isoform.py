...
ax.set_title("Stability of Dominant Isoform Identity\nAcross All 18 Samples (No TPM Filter)",
             fontsize=14, pad=20)

plt.tight_layout()

output_path = os.path.expanduser(
    "~/finalproject/results/plots/plot_dominant_stability_pie_no_filter.png")
